sap.ui.define([
	...
	return BaseObject.extend("com.globalintelli.ZAE_MMSA.controller.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.globalintelli.ZAE_MMSA.controller.ListSelector
		 */
		...
		selectAListItem: function (sBindingPath) {
			...
			this.oWhenListLoadingIsDone.then(
				...
				function () {
					Log.warning(this.getView().getModel("i18n").getResourceBundle().getText("Warning1") +
						sBindingPath + this.getView().getModel("i18n").getResourceBundle().getText("Warning2"));
				}
			);
		},

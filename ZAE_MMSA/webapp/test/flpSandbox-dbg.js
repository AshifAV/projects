		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ServiceAdvisor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ServiceAdvisor-display": {
								"semanticObject": "ServiceAdvisor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.globalintelli.ZAE_MMSA",
									"url": sap.ui.require.toUrl("com/globalintelli/ZAE_MMSA")
								}
							}
						}
					}
